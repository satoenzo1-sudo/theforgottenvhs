  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden vhs-noise pt-20">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        delay: 0.2
          ...
          <h1 className="text-5xl md:text-7xl font-typewriter font-bold text-aged-paper mb-4 block text-vhs-red">Você teria coragem de abrir um arquivo proibido e obscuro, esquecido há mais de 40 anos no interior dos EUA?</h1>
